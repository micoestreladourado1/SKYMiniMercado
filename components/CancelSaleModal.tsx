...
const CancelSaleModal: React.FC<CancelSaleModalProps> = ({ isOpen, onClose, onConfirm }) => {
    ...
    const modalContent = (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
            <div className="bg-gray-800 rounded-lg shadow-xl w-full max-w-md p-6 border border-gray-700 text-center">
                ...
                <h2 className="text-2xl font-bold text-white mt-4">Cancelar Venda</h2>
                <p className="text-gray-400 mt-2">
                    Tem certeza que deseja cancelar a venda atual?
                </p>
                <p className="text-yellow-400 font-semibold mt-1">
                    Todos os itens retornarão ao estoque e esta ação não poderá ser desfeita.
                </p>
